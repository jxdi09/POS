...
function renderHistory(container) {
  ...
  if (state.orders.length === 0) {
    tbody.innerHTML = `<tr><td colspan="8" style="text-align: center; color: var(--text-light); padding: 40px;">à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸žà¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸›à¸£à¸°à¸§à¸±à¸•à¸´à¸¢à¸­à¸”à¸‚à¸²à¸¢</td></tr>`;
  } else {
    state.orders.forEach(order => {
      ...
      let chLabel = 'à¸«à¸™à¹‰à¸²à¸£à¹‰à¸²à¸™'; let chClass = 'walkin';
      ...
      tr.innerHTML = `
        ...
        <td style="font-family: var(--font-latin); font-weight: 600; color: ${order.profit >= 0 ? 'var(--secondary)' : '#FF4D4F'}">à¸¿${order.profit.toFixed(1)}</td>
